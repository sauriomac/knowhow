...
const QuienesSomos: React.FC = () => {
  return (
    <>
      <div className="w-full pt-12 mb-64">
        <Image src={logoRebel} alt="Logo" className="mx-auto w-3/6 md:w-2/4 mt-16 mb-48 md:block hidden" />
        <div className="flex flex-col md:flex-row mt-20">
          <div className="w-full md:w-10/12 md:px-0 md:ml-48 px-4">
            ...
            Además, desarrollamos experiencias inmersivas mediante realidad aumentada, realidad virtual y videojuegos personalizados, aplicando tecnologías como Unity, Unreal Engine y WebXR. Creamos soluciones interactivas que transforman la forma en que las empresas capacitan, comunican, venden e innovan.
</p>
            <p className="text-white lg:text-[23px] mt-8 text-left text-sm md:text-base lg:leading-relaxed">
