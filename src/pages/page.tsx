    ...
    <>
      <div className="w-full pt-12">
        ...
        <div className='flex flex-col md:flex-row mt-20'>
          <div className='w-full md:w-1/2 md:px-0 md:ml-48'>
            <p className=' lg:text-[40px] lg:w1/1 font-bold text-red-700 mt-12'>¿Cómo asegurarás la excelencia
              operativa en un mundo digital que evoluciona constantemente?</p>
            <p className='lg:text-[26px] mt-8 text-left'>
        ...
        <div className='flex flex-col md:flex-row mt-36 mx-4 md:mx-12 capsule-rt text-center'>
          <div className=' md:w-1/3 m-4 mt-1'>
            <div className='md:-mt-28 bg-custom-gradient  min-h-[460px] pt-24 p-8 md:p-8 md:pt-4 rounded-md '>
              ...
              <p className='mt-3 md:text-[30px] md:mt-6 font-bold text-[#EFCE40]'>
                Desarrollo de Software
              </p>
              <p className=' md:text-[24px] mt-6'>
                Innovación en cada línea de
                código. Desarrollo de software a
                la medida de tus necesidades
                empresariales. RebelTech
                Solutions Donde las ideas se
          ...
          <div className=' md:w-1/3 m-4 mt-1'>
            <div className='md:-mt-28 bg-custom-gradient  min-h-[460px] pt-24 p-8 md:p-8 md:pt-4 rounded-md'>
              ...
              <p className=' md:text-[24px] mt-6'>
                Blindaje digital con Xcitium y
                Sendmarc. Explora la
                ciberseguridad que protege y
                empodera tu
                empresa. la seguridad es nuestra
                prioridad.</p>
            </div>
          </div>
          <div className=' md:w-1/3 m-4 mt-1'>
            <div className='md:-mt-28 bg-custom-gradient  min-h-[460px] pt-24 p-8 md:p-8 md:pt-4 rounded-md'>
              ...
              <p className='mt-3 md:text-[24px]'>
                Inteligencia de datos, estrategias
                inteligentes. Expertos en Data
                Science desbloqueando insights
                para el éxito de tu negocio.
                RebelTech Solutions Impulsando
                la innovación basada en datos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='mt-40 mb-32'>
          ...
          <div className='w-full md:w-3/5 px-10 md:px-10 md:ml-96'>
            <p className='lg:text-[30px] mt-8 text-left font-bold text-4xl leading-normal'>Detectar amenazas cibernéticas frente a detener el daño de las amenazas cibernéticas , dos cosas muy diferentes.</p>
            <p className='lg:text-[30px] mt-1 text-left font-bold text-4xl leading-normal text-[#EFCE40]'>Los EDR, MDR y XDR con alimentación ZeroDwell de detección de Xcitium derrotan las amenazas indetectables y previenen el daño cibernético</p>
          ...
          <div className='w-full md:w-3/5 px-10 md:px-10 md:ml-96 '>
            <p className='lg:text-[30px] mt-8 text-left font-bold text-4xl leading-normal text-[#EFCE40]'>PROTEJA EL NOMBRE DE SU MARCA</p>
            <p className='lg:text-[30px] mt-1 text-left font-bold text-4xl leading-normal'>
