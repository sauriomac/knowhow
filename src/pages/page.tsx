  ...
  <div className="w-full pt-12">
    ...
    <div className="flex flex-col md:flex-row mt-20">
      <div className="w-full md:w-1/2 md:px-0 md:ml-48 px-4">
        <p className="lg:text-[33px] font-bold text-yellow-300 mt-12 text-center md:text-left">
...
Superamos los desafíos tecnológicos donde las estrategias tradicionales ya no bastan, conectando futuro y eficiencia en cada línea de código..
    ...
    <div className="flex flex-col md:flex-row mt-64 mb-[48rem] mx-4 md:mx-12 capsule-rt text-center">
...
Creamos soluciones ágiles y basadas en datos que impulsan tu crecimiento. Desde plataformas inteligentes hasta experiencias inmersivas en realidad aumentada y virtual, conectamos tecnología y personas para optimizar tus procesos, acelerar tus resultados y generar valor real para tu negocio.</p>
        </div>
      </div>
      <div className="md:w-1/3 m-4 mt-1">
        <div className="md:-mt-28 bg-custom-gradient min-h-[476px] pt-24 p-8 md:p-8 md:pt-4 rounded-md">
...
Explora soluciones de ciberseguridad que no solo protegen, sino que empoderan tu operación digital. Implementamos defensas proactivas, monitoreo continuo y prácticas avanzadas como pentesting e informes especializados para mantener tu infraestructura segura, disponible y confiable.<br/>
          </p>
        </div>
      </div>
      <div className="md:w-1/3 m-4 mt-1">
...
Decisiones que transforman con datos reales.
Aplicamos ciencia de datos para convertir la información en estrategias inteligentes. Desde analítica avanzada hasta modelos predictivos, desbloqueamos insights clave que impulsan la innovación, optimizan recursos y elevan el rendimiento de tu empresa.          </p>
        </div>
      </div>
    </div>
  </div>
