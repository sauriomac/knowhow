    ...
    <nav className="p-10">
      <div className="flex justify-between items-center md:justify-center">
        ...
        <div className="text-white md:hidden" onClick={toggleMenu}>
          <Image
            ...
            alt="Menu"
            width={isMenuOpen ? 24 : 72}
            height={isMenuOpen ? 24 : 72}
          />
        </div>
      </div>
      <div className={`md:flex md:justify-center ${isMenuOpen ? 'block' : 'hidden'}`}>
        <div className="flex flex-col items-start mt-4 md:flex-row md:mt-0">
          ...
          <Link href="/contacto" className="text-white px-3 py-px md:text-[26px] font-medium text-xl tracking-widest" onClick={closeMenu}>
            Contacto
          </Link>
        </div>
      </div>
