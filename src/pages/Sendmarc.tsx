    ...
    return (
        ...
        <div className="container mx-auto px-4">
          <div className="mt-16 w-full md:w-4/5 m-auto">
            ...
            <p className="pt-8 text-base md:text-lg lg:text-xl text-center md:text-left lg:leading-relaxed">
          ...
          <div className="w-full md:w-4/5 mt-16 m-auto">
            ...
            <p className="text-base md:text-lg lg:text-xl text-center md:text-left lg:leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row pt-12 pb-12">
            <div className="my-8 w-full md:w-1/4 p-5">
              ...
              <p className="text-base md:text-lg lg:text-xl mb-4 text-center md:text-left">
          ...
          <div className="my-8 w-full md:w-4/5 m-auto pb-16">
            <p className="text-base md:text-lg lg:text-xl px-2 pt-16 text-center md:text-left lg:leading-relaxed">
