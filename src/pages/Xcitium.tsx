...
const Xcitium: React.FC = () => {
  ...
  <div className="container mx-auto px-4">
    <div className="mt-16 w-full md:w-4/5 mx-auto">
      ...
      <p className="text-white px-4 md:px-40 pt-8 text-base md:text-lg lg:text-xl  md:text-left lg:leading-relaxed">
    ...
    <div className="flex flex-col md:flex-row pb-12">
      <div className="my-8 w-full md:w-1/4 p-5">
        ...
        <p className="text-white text-base md:text-lg lg:text-xl mb-4 text-center md:text-left lg:leading-relaxed">
    ...
    <div className="my-8 w-full md:w-4/5 mx-auto pb-3 lg:leading-relaxed">
      ...
      <p className="text-white  text-base md:text-lg lg:text-xl px-2 text-center md:text-left"><span className="font-bold px-1">&#8226;</span>Servicios especializados para la identificación y mitigación de amenazas.</p>
      <p className="text-white  text-base md:text-lg lg:text-xl px-2 text-center md:text-left"><span className="font-bold px-1">&#8226;</span>Soporte experto en respuesta a incidentes y caza proactiva de amenazas.</p>
    </div>
    <div className="my-8 w-full md:w-4/5 mx-auto pb-8">
      ...
      <p className="text-white  text-base md:text-lg lg:text-xl px-2 text-center md:text-left"><span className="font-bold px-1">&#8226;</span>Apoyo técnico y profesional para implementación y mantenimiento.</p>
      <p className="text-white  text-base md:text-lg lg:text-xl px-2 text-center md:text-left"><span className="font-bold px-1">&#8226;</span>Implementación efectiva y soporte continuo en soluciones de seguridad.</p>
    </div>
    <div className="my-8 w-full md:w-4/5 mx-auto pb-16">
      <p className="text-white text-base md:text-lg lg:text-xl px-2 text-center md:text-left lg:leading-relaxed">
